...
def get_chat_message_list() : 
	excel_path = '../data/youtube_live_chats/check_20200922_live_chat.xlsx'
	...
	for result in result_data : 
		for word in result[1] : 
			if (word[1] == 'NNG' or word[1] == 'NNP' or word[1] == 'NP' or word[1] == 'VV' or word[1] == 'VA') and (len(word[0]) > 1) :
				...
				result.to_csv(f'C:/Users/PC/Documents/simbyungki/git/car_news_zip/data/youtube_live_chats/after_check_20200922_live_chat.csv', mode='a', header=False, encoding='utf-8-sig')
